              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
                  <div className="bg-white rounded-lg shadow-sm p-5">
                    ...
                    <div className="mt-4 flex items-center">
                      ...
                      <span className="text-xs text-gray-500 ml-2">
                        {Math.round(
                          (fleetSummary.activeVehicles / fleetSummary.totalVehicles) *
                            100
                        )}
                        % active
                      </span>
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-5">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-gray-500 text-sm">Current Alerts</p>
                        <h3 className="text-2xl font-bold mt-1">
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-5">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-gray-500 text-sm">Total Fuel Usage</p>
                        <h3 className="text-2xl font-bold mt-1">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                      ...
                      {vehicleStatuses.map((item) => (
                        ...
                        >
                          <div
                            ...
                            style={{
                              height: `${
                                (item.count / fleetSummary.totalVehicles) * 160
                              }px`,
                            }}
                          ></div>
                  ...
                  <div className="lg:col-span-2 bg-white rounded-lg shadow-sm p-5">
                    <h3 className="font-medium text-gray-700 mb-4">Fleet Location</h3>
                    <div className="bg-gray-100 h-64 rounded-lg relative">
                      ...
                      <div className="absolute inset-0 p-4 flex items-center justify-center">
                        <div className="text-center text-gray-400">
                          ...
                          <p>
                            Interactive map would display here with vehicle locations
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="absolute bottom-4 left-4 bg-white p-2 rounded-md shadow text-sm">
                        ...
                        <div className="flex items-center mb-1">
                          ...
                          <span>Maintenance ({vehicleStatuses[1].count})</span>
                        </div>
                        <div className="flex items-center">
                          <div className="w-3 h-3 rounded-full bg-red-500 mr-2"></div>
                          <span>Out of Service ({vehicleStatuses[2].count})</span>
                        </div>
                      </div>
                    </div>
                  </div>
